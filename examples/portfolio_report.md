# ClinicOps Portfolio Transition Brief
...
- Records reviewed: **3**
- Manufacturer-role legacy/legacy-screened records: **1**
- Manufacturer-role MDR/non-legacy records: **1**
...
- B-prefix used only as a derived legacy screening signal; absence of linked SS(C)P is not treated as non-compliance
- absence of linked SS(C)P is not treated as non-compliance
