...
'''
    ...
    html = html.replace(
        "</body>",
        '''<section class="notice"><h2>Want this applied to a real portfolio?</h2><p>Start with a small, controlled portfolio and a human-reviewed assessment.</p><p><a href="mailto:info@clinicops.dk?subject=Class%20III%20Transition%20Map%20Assessment">Request a Regulatory Intelligence Assessment</a> · <a href="/readiness-score.html">Use the free readiness score</a> · <a href="/">Back to ClinicOps</a></p></section>
</body>''',
        1,
    )
    return html
