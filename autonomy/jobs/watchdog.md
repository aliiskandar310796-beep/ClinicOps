...
- ClinicOps T0 Monitor · every 3 h 06:00–21:00 Madrid · `t0-monitor` · 60 s
...
## Checks
1. **Kill switch state.** Run the three HALT checks and report the state (a HALT that Ali did not announce is itself an alert).
